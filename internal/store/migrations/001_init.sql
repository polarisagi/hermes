...
('gemini_enterprise_agent_platform_key',         'gemini_enterprise_agent_platform', 'Gemini Enterprise Agent Platform Key',      'google',     'https://aiplatform.googleapis.com/v1/projects/{project_id}/locations/{region}/publishers/google',                           'query',  'key',                          '["api_key", "project_id", "region"]',           0),
...
('gemini_enterprise_agent_platform_anthropic_key','gemini_enterprise_agent_platform','Gemini Enterprise Agent Platform Anthropic Key','anthropic','https://aiplatform.googleapis.com/v1/projects/{project_id}/locations/{region}/publishers/anthropic',                          'query',  'key',                          '["api_key", "project_id", "region"]',           0),
