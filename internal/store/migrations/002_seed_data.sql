...
('GEAP_adc',         'GEAP', 'Agent Platform(原Vertex AI) ADC',      'google',     'https://aiplatform.googleapis.com/v1/projects/{project_id}/locations/{region}/publishers/google',                           'adc',    'Authorization',                '["project_id", "region"]',                      0),
('GEAP_key',         'GEAP', 'Agent Platform(原Vertex AI) Key',      'google',     'https://aiplatform.googleapis.com/v1/projects/{project_id}/locations/{region}/publishers/google',                           'query',  'key',                          '["api_key", "project_id", "region"]',           0),
('GEAP_anthropic_adc','GEAP','Agent Platform(原Vertex AI) Anthropic ADC','anthropic','https://aiplatform.googleapis.com/v1/projects/{project_id}/locations/{region}/publishers/anthropic',                          'adc',    'Authorization',                '["project_id", "region"]',                      0),
('GEAP_anthropic_key','GEAP','Agent Platform(原Vertex AI) Anthropic Key','anthropic','https://aiplatform.googleapis.com/v1/projects/{project_id}/locations/{region}/publishers/anthropic',                          'query',  'key',                          '["api_key", "project_id", "region"]',           0),
