...
('GEAP','Gemini Enterprise Agent Platform(原Vertex AI)',      NULL, 23),
...
('GEAP_adc',         'GEAP', 'Gemini Enterprise Agent Platform(原Vertex AI) ADC',      'google',     'https://aiplatform.googleapis.com/v1/projects/{project_id}/locations/{region}/publishers/google',                           'adc',    'Authorization',                '["project_id", "region"]',                      0),
('GEAP_key',         'GEAP', 'Gemini Enterprise Agent Platform(原Vertex AI) Key',      'google',     'https://aiplatform.googleapis.com/v1/projects/{project_id}/locations/{region}/publishers/google',                           'query',  'key',                          '["api_key", "project_id", "region"]',           0),
('GEAP_anthropic_adc','GEAP','Gemini Enterprise Agent Platform(原Vertex AI) Anthropic ADC','anthropic','https://aiplatform.googleapis.com/v1/projects/{project_id}/locations/{region}/publishers/anthropic',                          'adc',    'Authorization',                '["project_id", "region"]',                      0),
('GEAP_anthropic_key','GEAP','Gemini Enterprise Agent Platform(原Vertex AI) Anthropic Key','anthropic','https://aiplatform.googleapis.com/v1/projects/{project_id}/locations/{region}/publishers/anthropic',                          'query',  'key',                          '["api_key", "project_id", "region"]',           0),
...
('GEAP','gemini-3.5-flash',                  'gemini-3.5-flash'),
('GEAP','gemini-3.1-pro-preview',            'gemini-3.1-pro-preview'),
('GEAP','gemini-3.1-pro-preview-customtools','gemini-3.1-pro-preview-customtools'),
('GEAP','gemini-3.1-flash',                  'gemini-3.1-flash'),
('GEAP','gemini-3.1-flash-lite',             'gemini-3.1-flash-lite'),
